...
private:
	...
	int Triangle_ClipAgainstPlane(vec3d plane_p, vec3d plane_n, triangle& in_tri, triangle& out_tri1, triangle& out_tri2)
	{
		...
		if (nInsidePointCount == 1 && nOutsidePointCount == 2)
		{
			...
			out_tri1.luminance = in_tri.luminance;
		...
		if (nInsidePointCount == 2 && nOutsidePointCount == 1)
		{
			...
			out_tri2.luminance = in_tri.luminance;
...
public:
	bool OnUserCreate() override
	{
		...
		meshCube.LoadFromObjectFile("spyro_tris.obj",true);
		//meshCube.tris = {
		...
		sprTex1 = new olc::Sprite("High.png");
	...
	bool OnUserUpdate(float fElapsedTime) override
	{
		...
		//world matrix
		mat4x4 matWorld;
		matWorld = Matrix_MakeIdentity(); //form the world matrix
		matWorld = Matrix_MultiplyMatrix(matRotZ, matRotX); //rotate
		matWorld = Matrix_MultiplyMatrix(matWorld, matTrans); //translate
	...
	/*	for (auto& triProjected : vecTrianglesToRaster)
		...
		for (auto& triToRaster : vecTrianglesToRaster)
		{
			...
			for (auto& t : listTriangles)
			{
				...
				//FillTriangle(t.p[0].x, t.p[0].y, t.p[1].x, t.p[1].y, t.p[2].x, t.p[2].y, olc::Pixel(t.luminance,t.luminance, t.luminance));
				//cout << (int)t.luminance << endl;
